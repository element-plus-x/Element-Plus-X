...
Override `FilesCard` `--elx-*` variables via `ConfigProvider.themeOverrides` (background, border, delete button, etc.).
</docs>
...
<template>
  <div style="display: flex; flex-direction: column; gap: 12px">
    ...
    >
      <div>Click the delete button and see overridden styles.</div>
      <button
        type="button"
        style="
          padding: 6px 10px;
