...
<template>
  <li
    ...
    :class="[
      ...
      isHovered && !item.disabled ? props.itemsHoverClassName : '',
      isShowMenuBtn ? props.itemsMenuOpenedClassName : '',
      active ? props.itemsActiveClassName : ''
    ]"
    :style="{
      ...itemsStyle,
          ...
          <div class="conversation-label-container">
            ...
            >
              <span
                ...
                :class="[
                  { 'text-gradient': isTextOverflow(item.label) },
